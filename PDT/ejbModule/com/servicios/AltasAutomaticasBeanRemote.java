...
public class AltasAutomaticasBeanRemote implements IAltasAutomaticas {
	...
	private void autocargarRoles() {
		...
		this.em.flush();	//No necesito catch ya que no debería existir
	}
	...
	public Indicador altaAutomaticaIndicadores() throws IndicadorConPotrerosException {
		...
		try {
			...
			indicadorRaiz = new Indicador("TOTAL PREDIO","Área total del predio", fecha, "darkgreen");
			...
			Indicador indicadorRecria = new Indicador("RECRIA", "Superficie dedicada a Recría",fecha, "orange");
			...
			Indicador indicadorCamineria = new Indicador("CAMINERIA", "Superficies dedicadas a caminería",fecha,"mintcream");
			...
			Indicador indicadorSEPVO = new Indicador("SEPVO","Superficie Efectiva de Pastoreo de Vacas en Ordeñe",fecha,"aliceblue");
...
//		Coordenadas Potreros
		...
		Predio predio = new Predio(true, "Escuela de lechería", fecha, "Escuela de lechería de Nueva Helvecia", formaPredio);
